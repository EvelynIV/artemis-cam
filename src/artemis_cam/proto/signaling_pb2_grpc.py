...
def add_SignalingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'artemis_cam.signaling.v1.SignalingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('artemis_cam.signaling.v1.SignalingService', rpc_method_handlers)
